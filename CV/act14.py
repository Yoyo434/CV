...
image_path="minions.jpg"
image=cv2.imread(image_path)
image_rgb=cv2.cvtColor(image,cv2.COLOR_BGR2RGB)

height, width,_=image_rgb.shape

rect1_width, rect1_height=300, 200
top_left1=(20,20)
...
rect2_width, rect2_height= 400, 100
...
cv2.putText(image_rgb,'Region 1',(top_left1[0],top_left1[1]-10),font,0.7,(255,255,255),cv2.LINE_AA)
cv2.putText(image_rgb,'Region 2',(top_left2[0],top_left2[1]-10),font,0.7,(255,255,255),cv2.LINE_AA)
cv2.putText(image_rgb,'Center 1',(center1_x-40,
center1_y+40),font,0.6,(0,255,0),2,cv2.LINE_AA)
...
height_label_position=(arrow_start[0]-200,(arrow_start[1]+arrow_end[1])//2)
cv2.putText(image_rgb,'Height',(height_label_position[0],height_label_position[1]),font,0.7,(255,255,0),2,cv2.LINE_AA)
